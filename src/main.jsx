  ...
  return <main className="app-shell">
    ...
    <section className="workspace">
      ...
      <div className="tree-stage">
        ...
        <div className="watercolor-tree" aria-hidden="true"><img src="https://img.magnific.com/free-vector/watercolor-family-tree_23-2147602413.jpg?semt=ais_hybrid&w=740&q=80" alt="" /></div><div className="falling-leaves" aria-hidden="true">{Array.from({ length: 14 }, (_, index) => <i key={index} style={{ '--leaf-left': `${8 + ((index * 17) % 84)}%`, '--leaf-delay': `${(index % 7) * -1.3}s`, '--leaf-drift': `${index % 2 ? 34 : -28}px` }} />)}</div><div className="tree-canvas" style={{ transform: `scale(${zoom})`, transformOrigin: 'center top' }}>
