  ...
  return <main className="app-shell">
    ...
    <section className="workspace">
      ...
      <div className="tree-stage">
        <div className="stage-note"><span className="line-dot" /> Click any person to explore their branch</div>
